...
#ifndef DAVINCICOIN_KEYSTORE_H
#define DAVINCICOIN_KEYSTORE_H
...
public:
    ...
    virtual bool HaveWatchOnly(const CKeyID &id) const =0;
...
public:
    ...
    bool HaveWatchOnly(const CKeyID &id) const override;
